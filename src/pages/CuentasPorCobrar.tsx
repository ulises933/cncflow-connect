          ...
          {detail && (
            <div className="space-y-6">
              ...
              {detail.status !== "cobrada" && (
                <Button onClick={() => setCobroOpen(true)} className="bg-success hover:bg-success/90 text-success-foreground">
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input value={cobroRef} onChange={e => setCobroRef(e.target.value)} placeholder="Número de referencia bancaria" />
            </div>
            <div>
              <label className="text-sm font-medium">Notas</label>
              <Textarea value={cobroNotas} onChange={e => setCobroNotas(e.target.value)} placeholder="Observaciones..." />
            </div>
